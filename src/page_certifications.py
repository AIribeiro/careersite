...
<section class="section soft"><div class="container"><div class="head"><div><p class="eyebrow">Selected credentials</p><h2>The credentials with the strongest signal for my current market position.</h2></div><p>Recency matters, but so does fit. These are the credentials most relevant to enterprise AI strategy, Responsible AI, adoption, operating models, data and informed technical leadership.</p></div><div class="cert-grid">{flagship}</div></div></section>
