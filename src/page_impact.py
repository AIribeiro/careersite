...
def impact() -> str:
    cases = [
        ...
        case(
            ...
            [
                ...
                ("What changed", "The work made it clearer which opportunities deserved attention, who was responsible at each stage, how data stewardship should begin and what needed to be true before broader use. It also made the remaining organizational dependencies more explicit."),
            ],
        ),
        case(
            "Kimberly-Clark",
    ...
    return f'''{nav("impact")}<main><section class="pagehero"><div class="container"><p class="eyebrow">Leadership impact</p><h1>Leadership evidence through situations, choices and trade-offs.</h1><p>Across these roles, my work has centered on making AI decisions executable: clarifying responsibility, exposing trade-offs, connecting business and technical realities, and creating the conditions for adoption, governance and responsible scale.</p></div></section>{practice}<section class="section paper"><div class="container">{"".join(cases)}</div></section>{leadership_frameworks()}<section class="section navy"><div class="container"><div class="head"><div><p class="eyebrow">Recurring trade-offs</p><h2>The tensions repeat. The balance changes with context.</h2></div><p>These are recurring enterprise decisions rather than universal rules. I try to make the tension explicit, identify what needs to be demonstrated and decide what level of structure the organization can use productively at that point.</p></div><div class="flow"><div class="step"><span>01</span><strong>Speed ↔ governance</strong></div><div class="step"><span>02</span><strong>Experiment ↔ scale</strong></div><div class="step"><span>03</span><strong>Central ↔ federated</strong></div><div class="step"><span>04</span><strong>Ambition ↔ data maturity</strong></div><div class="step"><span>05</span><strong>Sophistication ↔ adoption</strong></div><div class="step"><span>06</span><strong>Volume ↔ investment focus</strong></div></div><p class="flowcopy">Early experimentation may need speed; broader use needs stronger proof and clearer responsibility. Central capability can accelerate learning; distributed accountability is usually required for adoption. The useful leadership question is when the balance has to move.</p></div></section>{technical}{opportunity()}</main>{footer()}'''
