...
ARTICLES: tuple[ArticleMeta, ...] = (
    ArticleMeta(
        ...
        kind="Point of view",
        topic="Enterprise AI",
        standfirst="A pilot can prove that an AI idea works. It does not prove that the organization is ready to own it, govern it, adopt it or repeat the result at scale.",
    ...
    ArticleMeta(
        ...
        kind="Decision note",
        topic="AI Governance",
        standfirst="Explicit human accountability before an AI use case moves into production-scale decisions.",
        published_iso="2026-09-17",
        published_label="17 Sep 2026",
        read_minutes=1,
        seo_title="The AI Governance Gate I Would Never Remove | Jair Ribeiro",
        seo_description="A concise decision note on the governance requirement I would never remove from enterprise AI: explicit human accountability for outcomes.",
    ...
    ArticleMeta(
        ...
        standfirst="A long list of AI ideas can create the appearance of momentum. A portfolio starts only when the organization is prepared to choose, sequence and stop.",
        published_iso="2026-09-17",
        published_label="17 Sep 2026",
        read_minutes=5,
    ...
    ArticleMeta(
        ...
        kind="Decision note",
        topic="AI Adoption",
        standfirst="Active users can tell me that people opened the tool. They do not tell me that work changed.",
        published_iso="2026-09-17",
        published_label="17 Sep 2026",
        read_minutes=1,
        seo_title="One AI Adoption Metric I Don't Trust | Jair Ribeiro",
        seo_description="Why licenses, logins and active users are weak evidence of AI adoption, and why workflow and behavior change provide a stronger signal.",
