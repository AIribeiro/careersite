...
ARTICLES: tuple[ArticleMeta, ...] = (
    ...
    ArticleMeta(
        ...
        seo_description="Six signals for reopening an AI investment decision, from weak value mechanisms and unrealistic operating conditions to adoption costs, risk economics and stronger alternatives.",
