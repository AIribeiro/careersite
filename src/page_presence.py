...
<article class="card presence-card">{_media(presence_ai_learning, "Jair Ribeiro with participants after an AI learning session")}<div class="presence-body"><span class="org">Enterprise learning</span><h3>100+ AI learning sessions at Volvo Group</h3><p>This is supporting enablement evidence: the sessions strengthened AI literacy and the quality of business demand. Operational adoption is evidenced separately through AI solutions and agents introduced into warranty, sales and aftermarket workflows and through lifecycle and scale-readiness mechanisms.</p></div></article>
</div></div></section>
