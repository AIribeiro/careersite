...
def impact() -> str:
    cases = [
        ...
        case(
            ...
            "Enterprise CoE mandate across strategy, operations, technology and business leaders · AI portfolio · governance · data foundations · adoption",
            ...
            [
                ...
                ("My responsibility", "I led the AI and data excellence agenda across the organization, shaping the CoE foundations: portfolio structure, lifecycle stages, governance mechanisms, maturity assessment, data stewardship, adoption connections and the capability model needed to mature the function."),
                ...
                ("What I chose / influenced", "I favored a small number of connected decision mechanisms: clearer portfolio visibility, practical lifecycle discipline, risk-aware criteria, stewardship and the proof needed before broader use. I also connected the maturity assessment to a pragmatic 2026–2027 roadmap rather than treating maturity as a score in isolation."),
                ("What changed", "The CoE became a more defined business-facing capability: a visible AI opportunity portfolio, clearer lifecycle stages and responsibilities, a 2026–2027 maturity roadmap, initial data-ownership and stewardship foundations, and explicit capability gaps that informed the creation of new roles."),
            ],
        ),
        case(
            "Kimberly-Clark",
            ...
            "EMEA role · reporting directly to the Chief Data & Analytics Officer · supply chain, manufacturing, logistics, sales and marketing",
            ...
            [
                ...
                ("My responsibility", "In a global role reporting directly to the CDAO, I led value discovery and realization work across EMEA, helping business leaders and data-science teams frame the problem, expected value, feasibility and delivery considerations in a form both sides could work with."),
