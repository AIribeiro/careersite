IMAGE_CSS = """
<style>
/* Leadership photography is evidence: purposeful, responsive and never upscaled. */
.hero .portrait{overflow:hidden;background:#111b2c}
.hero .portrait img{width:100%;height:auto;aspect-ratio:4/3;object-fit:cover;object-position:center 34%;display:block}
...
.editorial-photo{overflow:hidden;background:#111b2c}
.editorial-photo img{display:block;width:100%;height:auto;aspect-ratio:4/3;object-fit:cover;object-position:center}
...
.contactportrait img{display:block;width:100%;height:auto;aspect-ratio:1/1;object-fit:cover;object-position:center 28%}
.lensphoto{margin:24px 0;overflow:hidden;background:#111b2c}
.lensphoto img{display:block;width:100%;height:auto;aspect-ratio:16/10;object-fit:cover;object-position:center}
