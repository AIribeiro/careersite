...
<section class="pagehero"><div class="container"><p class="eyebrow">Thinking</p><h1>How I think about building enterprise AI that actually works.</h1><p>This is where I make my leadership perspective visible. These articles show how I approach the decisions behind enterprise AI — strategy, investment, operating models, governance, adoption and scale — grounded in real experience and practical trade-offs. The aim is not to comment on AI from the sidelines, but to show how I turn ambition into trusted, usable and lasting business capability.</p></div></section>
<section class="section paper"><div class="container"><div class="head"><div><p class="eyebrow">What I’m thinking about now</p><h2>Fresh arguments, short notes and practical frameworks.</h2></div><p>New material appears here first. I use it to make the judgment behind enterprise AI and Data leadership visible while the questions are still current.</p></div>
...
<section class="section white"><div class="container"><div class="head"><div><p class="eyebrow">Recent thinking</p><h2>Earlier topics remain part of the working record.</h2></div><p>Current material moves to the top without disappearing when the next argument is published.</p></div>{_recent_cards()}{_upcoming_preview()}</div></section>
