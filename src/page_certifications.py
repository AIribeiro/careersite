...
<section class="section navy eitca-feature"><div class="container"><div class="eitca-top"><div><p class="eyebrow">Featured technical foundation</p><h2>EITCA/AI Artificial Intelligence Academy</h2><p class="eitca-lead">European AI certification programme comprising <strong>24 ECTS</strong> and <strong>12 component certifications</strong> across artificial intelligence, machine learning, deep learning, Python and cloud technologies.</p></div><div class="eitca-facts"><div><strong>24 ECTS</strong><span>Structured AI curriculum</span></div><div><strong>12</strong><span>Component certifications</span></div><div><strong>2025</strong><span>Credential awarded</span></div></div></div><div class="eitca-body"><div><h3>Leadership relevance</h3><p>The credential adds formal technical depth to enterprise AI leadership: enough grounding to engage architects, data scientists and engineering teams, assess technical trade-offs, understand dependencies across AI and cloud environments, and connect technology choices with governance, adoption and business value.</p><div class="actions"><a class="btn ghost" href="https://www.eitci.org/val.php?id=EITCA/AI/SLJ25004525&t=j5xq3TMD6GcHgrj9" target="_blank" rel="noopener">Verify credential ↗</a><a class="btn ghost" href="https://eitca.org/eitca-ai-artificial-intelligence-academy/" target="_blank" rel="noopener">Programme scope ↗</a></div><p class="eitca-id">Credential ID · EITCA/AI/SLJ25004525 · EITCA Academy</p></div><details class="cert-archive"><summary>View 12 component certifications</summary><ul>{eitca}</ul></details></div></div></section>
